...
class MessageEventInit: EventInit {
    ...
    var data: String { didSet { print("[MessageEventInit] { data: \(data) }") } }
    var origin: String { didSet { print("[MessageEventInit] { origin: \(origin) }") } }
    var lastEventId: String { didSet { print("[MessageEventInit] { lastEventId: \(lastEventId) }") } }
    var source: EventTarget? { didSet { print("[MessageEventInit] { source: \(source) }") } }
    var ports: Array<MessagePort> { didSet { print("[MessageEventInit] { ports: \(ports) }") } }
